	...
	return (
		<>
			<div className='container'>
				...
				<Divider/>
				{ data ? data.filter(item => item.room === 'Conference Room' && item.deviceType === 'Lights').map((item, index) => {
			...
			<div className='container'>
				...
				<Divider/>
				{ data ? data.filter(item => item.room === 'Conference Room' && item.deviceType === 'Air Con').map((item, index) => {
					const onToggle = (checked) => {
			...
			<div className='container'>
				...
				<Divider/>
				{ data ? data.filter(item => item.room === 'Conference Room' && item.deviceType === 'Fan').map((item, index) =>	{
					const onToggle = (checked) => {
